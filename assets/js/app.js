    ...
    card.innerHTML = `
        <h2 class="title-2 card-title">Now</h2>
                        ...
                        <div class="weapper">
                            ...
                            <img src='./assets/images/weather_icons/${icon}.png' width="50" height="50"
                                alt="${description}" class="weather-class">
                        </div>
...
<img src='./assets/images/weather_icons/${icon}.png' width="25" height="25" alt="${description}"
